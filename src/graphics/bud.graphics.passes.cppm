...
// import bud.graphics.renderer; // Removing circular dependency
import bud.math;
import bud.scene; // [新增] 引入 Scene 定义
import bud.io;
...
export namespace bud::graphics {
	...
	class CSMShadowPass {
		...
		Texture* static_cache_texture = nullptr; // [CSM] Persistent Cache
		bud::math::vec3 last_light_dir = bud::math::vec3(0.0f);
		bool cache_initialized = false;
		RHI* stored_rhi = nullptr; // [CSM] Store RHI for lazy creation
